...
public partial class FotMobWorldCupScraper
{
    ...
    private static WorldCupPlayerStatsPlayerResponse MockPlayerStatsPlayer(WorldCupLineupTeamResponse team, WorldCupLineupPlayerResponse player, int playerIndex, int step)
    {
        ...
        var crosses = isGoalkeeper ? 0 : (activeStep + playerIndex % 3) / 4;
        var longBalls = isGoalkeeper ? activeStep + 2 : activeStep / 2 + playerIndex % 4;
        ...
        var categories = new List<WorldCupPlayerStatCategoryResponse>
        {
            ...
            [
                ...
                MockStat("dribbles_succeeded", "Successful dribbles", isGoalkeeper ? 0 : (activeStep + playerIndex % 2) / 3),
            ...
            [
                ...
                MockStat("passes_into_final_third", "Passes into final third", isGoalkeeper ? activeStep / 5 : activeStep + playerIndex % 4),
            ...
            [
                ...
                MockStat("shot_blocks", "Shot blocks", isGoalkeeper ? 0 : (activeStep + playerIndex % 3) / 6),
                MockStat("recoveries", "Recoveries", isGoalkeeper ? activeStep / 5 : activeStep / 2 + playerIndex % 2),
                MockStat("clearances", "Clearances", isGoalkeeper ? activeStep / 6 : activeStep / 3 + playerIndex % 3),
                MockStat("headed_clearance", "Headed clearances", isGoalkeeper ? 0 : (activeStep + playerIndex % 2) / 4),
            ...
            [
                ...
                MockStat("aerials_won", "Aerial duels won", isGoalkeeper ? 0 : (activeStep + playerIndex % 4) / 4),
